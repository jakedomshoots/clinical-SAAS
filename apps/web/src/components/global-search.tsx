...
const SEARCHABLE_SECTIONS: SearchableSection[] = [
  {
    id: 'live-use-rehearsal',
    tabId: 'staff-training',
    tabLabel: 'Staff & Training',
    title: 'Live-Use Rehearsal Board',
    keywords: ['rehearsal', 'practice', 'runthrough', 'gates', 'evidence'],
  },
  {
    id: 'staff-training',
    tabId: 'staff-training',
    ...
    keywords: ['training', 'staff', 'onboarding', 'completion', 'certification'],
  },
  {
    id: 'role-dry-run',
    tabId: 'staff-training',
    ...
    keywords: ['dry run', 'role', 'checklist', 'workflow', 'validation'],
  },
  {
    id: 'dry-run-session',
    tabId: 'staff-training',
    ...
    keywords: ['session', 'evidence', 'dry run', 'log'],
  },
  {
    id: 'credential-binder',
    tabId: 'compliance-security',
    tabLabel: 'Compliance & Security',
    title: 'Credential Binder',
    keywords: ['credentials', 'binder', 'vendor', 'insurance', 'verification'],
  },
  {
    id: 'vendor-credential',
    tabId: 'compliance-security',
    tabLabel: 'Compliance & Security',
    title: 'Vendor Credential Packet',
    keywords: ['vendor', 'credential', 'packet', 'compliance'],
  },
  {
    id: 'browser-qa',
    tabId: 'systems-data',
    tabLabel: 'Systems & Data',
    title: 'Browser QA Evidence',
    keywords: ['browser', 'qa', 'testing', 'chrome', 'safari'],
  },
  {
    ...
    keywords: ['integration', 'adapter', 'api', 'connection', 'sync'],
  },
  {
    id: 'document-storage',
    tabId: 'systems-data',
    ...
    keywords: ['storage', 'documents', 'files', 'backup', 's3'],
  },
  {
    ...
    keywords: ['config', 'audit', 'production', 'settings', 'environment'],
  },
  {
    id: 'operator-health',
    tabId: 'systems-data',
    ...
    keywords: ['health', 'status', 'uptime', 'monitoring', 'operator'],
  },
  {
    id: 'policy-approval',
    tabId: 'compliance-security',
    ...
    keywords: ['policy', 'approval', 'compliance', 'review', 'sign-off'],
  },
  {
    id: 'restore-drill',
    tabId: 'compliance-security',
    ...
    keywords: ['restore', 'drill', 'disaster', 'recovery', 'backup', 'rto', 'rpo'],
  },
  {
    ...
    keywords: ['cutover', 'readiness', 'go-live', 'deployment', 'launch'],
  },
  {
    id: 'cutover-runbook',
    tabId: 'go-live',
    ...
    keywords: ['runbook', 'cutover', 'steps', 'procedure', 'rollback'],
  },
  {
    id: 'go-live-packet',
    tabId: 'go-live',
    ...
    keywords: ['go-live', 'packet', 'launch', 'attestation', 'approval'],
  },
  {
    id: 'launch-workplan',
    tabId: 'go-live',
    ...
    keywords: ['workplan', 'launch', 'timeline', 'tasks', 'milestones'],
  },
  {
    id: 'production-rehearsal',
    tabId: 'compliance-security',
    tabLabel: 'Compliance & Security',
    title: 'Production Rehearsal',
    keywords: ['rehearsal', 'production', 'dry run', 'final check'],
  },
  {
    id: 'incident-register',
    tabId: 'post-launch',
    tabLabel: 'Post-Launch',
    title: 'Incident Register',
    keywords: ['incident', 'register', 'issues', 'problems', 'alerts'],
  },
  {
    ...
    keywords: ['events', 'integration', 'failed', 'errors', 'logs'],
  },
  {
    ...
    keywords: ['billing', 'claims', 'queue', 'payments', 'invoices'],
  },
];
