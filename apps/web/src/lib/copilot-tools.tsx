...
const confirmationParameters = z.object({
  context: z.string().describe('The route, patient, queue, or clinical context for the proposed action.'),
  rationale: z.string().optional().describe('Short explanation of why this action should be staged.'),
});
...
function confirmationResponse(toolId: AssistantToolId, args: ConfirmationArgs) {
  ...
  return {
    ...
    nextStep: 'Open the Concierge OS clinical assistant panel and confirm the matching action before any patient data is changed.',
  };
}
  ...
  useFrontendTool(
    {
      ...
      description: 'Stages a follow-up task from clinical context. Requires staff confirmation before creation.',
  ...
  useFrontendTool(
    {
      ...
      description: 'Stages a portal reply draft. Requires staff confirmation and never sends automatically.',
      parameters: confirmationParameters,
  ...
  useFrontendTool(
    {
      ...
      description: 'Stages a fax-to-patient match for staff review. Requires staff confirmation before changing the fax.',
      parameters: confirmationParameters,
