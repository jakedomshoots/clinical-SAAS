...
def production_config_audit() -> dict:
    checks = [
        ...
        _config_check(
            ...
            "critical",
            "Inbound vendor callbacks require a shared signing secret, fresh timestamp header, and stable event id.",
            "Set WEBHOOK_SHARED_SECRET and configure vendors to send X-Concierge-Webhook-Secret, X-Concierge-Webhook-Timestamp, and event_id.",
