...
def production_config_audit() -> dict:
    checks = [
        ...
        _config_check(
            ...
            "critical",
            "Inbound vendor callbacks require a shared signing secret and fresh timestamp header.",
            "Set WEBHOOK_SHARED_SECRET and configure vendors to send X-Concierge-Webhook-Secret plus X-Concierge-Webhook-Timestamp.",
