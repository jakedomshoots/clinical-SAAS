"""Quest Diagnostics integration adapter.

Handles lab order submission and result retrieval via
Quest's Care360 API or HL7 interface.

API Docs: https://developer.questdiagnostics.com/
"""
...
class QuestClient(ConfiguredIntegration):
    """Quest Diagnostics Care360 API client."""

    name = "quest"
    env_var = "QUEST_API_KEY"
    adapter_detail = "Quest Diagnostics Care360 API — lab orders and results"
    ...
    @with_api_retry(circuit_breaker="quest")
    async def submit_lab_order(
        ...
        Args:
            ...
            test_codes: Quest test codes (e.g. ["CBC", "CMP"])
