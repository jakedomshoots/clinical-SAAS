...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('preferred_contact_channel', sa.String(20), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column('pages', sa.Integer(), server_default='1'),
        sa.Column('file_url', sa.String(500), nullable=True),
        sa.Column('upload_status', sa.String(50), nullable=False, server_default='metadata_only', index=True),
        sa.Column('ocr_status', sa.String(50), nullable=False, server_default='not_started', index=True),
    ...
    op.create_table(
        ...
        sa.Column('claim_control_number', sa.String(100), nullable=True, index=True),
        sa.Column('submission_ready_at', sa.DateTime(), nullable=True),
        sa.Column('submitted_at', sa.DateTime(), nullable=True),
        sa.Column('denied_at', sa.DateTime(), nullable=True),
        sa.Column('denial_reason', sa.Text(), nullable=True),
        sa.Column('denial_worked_at', sa.DateTime(), nullable=True),
        sa.Column('remittance_status', sa.String(50), nullable=False, server_default='not_received', index=True),
