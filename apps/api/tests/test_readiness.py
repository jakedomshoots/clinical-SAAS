...
def test_external_integrations_default_to_demo_mode(monkeypatch):
    ...
    integrations = readiness_service.check_external_integrations()
...
def test_external_integrations_report_configured_values(monkeypatch):
