...
- Use Integration Cutover Readiness Packet to review one vendor lane at a time across adapter implementation, credential request readiness, handoff archive state, cutover rehearsal evidence, sandbox references, risks, blockers, next actions, and go/hold/no-go status.
