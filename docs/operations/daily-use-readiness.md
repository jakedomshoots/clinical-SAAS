...
- Integration Setup includes credential preflight for vendor env/draft fields, placeholder-adapter blockers, connection-test status, and sandbox workflow evidence.
