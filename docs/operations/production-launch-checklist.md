...
- `/api/integrations/credential-preflight` has no missing, blocked, or placeholder-adapter integration items, and every sandbox workflow has recorded passing evidence with notes or a vendor reference; empty pass records are rejected.
