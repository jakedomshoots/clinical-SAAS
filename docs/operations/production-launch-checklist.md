...
- `WEBHOOK_SHARED_SECRET` is unique, random, shared only with trusted webhook senders, and vendors send `X-Concierge-Webhook-Timestamp` within the replay window.
